...
// const useAverageSessionUrl = mock
//   ? "/userAverageSession.json"
//   : "http://localhost:3000/user/${id}/average-sessions"
// const usePerformanceUrl = mock
...
import { getUserById, getUserActivities } from "./service"
...
function App() {
  ...
  useEffect(() => {
    ...
    const fetchUserActivities = async () => {
      const sessions = await getUserActivities(id)
      setBarchartData(sessions)
    }
